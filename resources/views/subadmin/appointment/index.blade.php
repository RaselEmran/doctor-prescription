          ...
          <div class="card-header" style="background: #5A9599;color: #fff">
            <h3>New Patient Appointment</h3>
                           ...
                           <div style="margin-top: 25px">
                                ...
                                <a href="{{route('user.appointment.new')}}" class="btn btn-info margin-5"  style="float: right;">
                                    Add New Appointment
                                </a>
                           </div>
                            <!-- Tab panes -->
          ...
          <div class="card-header" style="background: #5A9599;color: #fff">
            <h3>Old Patient Appointment</h3>
                           ...
                           <div style="margin-top: 25px">
                                ...
                                <!-- Button trigger modal -->
                                <a href="{{route('user.appointment.old')}}" class="btn btn-info margin-5"  style="float: right;">
                                    Add Old Appointment
                                </a>
                           </div>
                            <!-- Tab panes -->
  ...
  $(".edit-ap").click(function(){
    ...
    var oap_id =$(this).attr('oap_id');
          ...
          $.ajax({
              ...
              type: 'POST',
              url: "{{URL::to('/user/newapoint/oldprint')}}",
              data : {oap_id:oap_id},
              dateType: 'json',
              success: function(data){
