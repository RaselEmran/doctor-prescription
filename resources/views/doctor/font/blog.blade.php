    ...
    <div class="col-md-10" style="width: 95%;margin: auto; padding-top: 20px">
                      <div class="card">
                        <div class="card-header" style="background: #5A9599;color: #fff">
                          <h3>Blog Post</h3>
                          <a href="{{ route('admin.fontpage.postlist') }}" class="btn btn-success" style="float: right;">Post List</a>
                        </div>
                     <form method="post" action="{{route('admin.fontpage.blog-store')}}" enctype="multipart/form-data">
                      {{@csrf_field()}}
