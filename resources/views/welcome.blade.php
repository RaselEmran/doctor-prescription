                ...
                <div class="navbar-header" data-logobg="skin5">
                    ...
                    <a class="navbar-brand" href="{{route('admin.dashboard')}}">
                        ...
                        <span class="logo-text">
                             <!-- dark Logo text -->
                             <img src="{{asset('backend/assets/images/logo.png')}}" alt="homepage" class="light-logo" width="235px" height="70px" />
                    ...
                    @else
                        ...
                        <span class="logo-text">
                             <!-- dark Logo text -->
                             <img src="{{asset('backend/assets/images/logo1.png')}}" alt="homepage" class="light-logo" width="220px" />
                    ...
                    <ul class="navbar-nav float-right">
                        ...
                        <li class="nav-item dropdown">
                            ...
                            <div class="dropdown-menu dropdown-menu-right user-dd animated">
                                ...
                                <div class="dropdown-divider"></div>
                                <div class="p-l-30 p-10"><a href="{{ route('admin.user') }}" class="btn btn-sm btn-success btn-rounded">Create user</a></div>
                            </div>
                            @else
                             <div class="dropdown-menu dropdown-menu-right user-dd animated">
                                <div class="dropdown-divider"></div>
                                <a class="dropdown-item" href="{{route('user.change')}}"><i class="ti-settings m-r-5 m-l-5"></i> Account Setting</a>
                                <div class="dropdown-divider"></div>
                                <a class="dropdown-item" href="{{route('logout')}}"><i class="fa fa-power-off m-r-5 m-l-5"></i> Logout</a>
                                <div class="dropdown-divider"></div>
